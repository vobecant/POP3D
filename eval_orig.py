...
def main(local_rank, args):
    ...
    with torch.no_grad():
        for i_iter_val, (imgs, img_metas, val_vox_label, val_grid, val_pt_labs, *_) in enumerate(val_dataset_loader):
            ...
            print(f'imgs[...,0]: {imgs[...,0]}, val_vox_label[...,0]: {val_vox_label[...,0]}, '
                  f'val_grid[...,0]: {val_grid[...,0]}')
            ...
            print(f'val_grid_float.unique(dim=1): {val_grid_float.unique(dim=1)}')
            ...
            # §print(locations_for_vox[:,0].max(),locations_for_vox[:,1].max(),locations_for_vox[:,2].max(),locations_for_vox[:,3].max())
