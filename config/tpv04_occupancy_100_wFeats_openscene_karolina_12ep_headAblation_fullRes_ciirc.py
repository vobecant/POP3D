...
val_data_loader = dict(
    ...
    imageset="./data/nuscenes_infos_val_new_openscene.pkl",
    batch_size=1,
    shuffle=False,
    num_workers=0,
)
...
dataset_params = dict(
    ...
    dataset_type='ImagePoint_NuScenes_withFeatures_openseg',
    ignore_label=255,
    fill_label=0,
    ...
    features_path="/home/vobecant/PhD/openscene/data/nuscenes_outputs_withPts", #"/nfs/datasets/nuscenes/openseg_data",
    labels_path="/home/vobecant/PhD/openscene/data/nuscenes_labels",
