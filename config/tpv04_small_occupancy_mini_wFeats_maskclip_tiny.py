...
dataset_params = dict(
    ...
    label_mapping="./config/label_mapping/nuscenes-tiny.yaml",
    label_mapping_gt="./config/label_mapping/nuscenes-tiny.yaml",
