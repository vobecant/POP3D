...
def main(local_rank, args):
    ...
    if clip_features:
        CalMeanIou_pts_clip = MeanIoU(unique_label, ignore_label, unique_label_str, 'pts_clip')
        CalMeanIou_pts_clip_visible = MeanIoU(unique_label, ignore_label, unique_label_str,
                                              'pts_clip_visible')
        CalMeanIou_vox_clip_all = MeanIoU(unique_label + [17], IGNORE_LABEL, unique_label_str + ['empty'],
                                          'vox_clip_all', extra_classes=0)
        CalMeanIou_vox_clip_occupied = MeanIoU(unique_label, ignore_label,
                                               unique_label_str, 'vox_clip_occupied', extra_classes=0,
                                               extra_classes_pred=1)
        CalMeanIou_pts_clip_gt = MeanIoU(unique_label, ignore_label, unique_label_str, 'vox_clip_occupied')
